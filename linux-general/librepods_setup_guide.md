...
Instead of manually moving the AppImage and creating desktop entries, Gearlever provides a graphical interface to organize AppImages, automatically generate desktop entries, and seamlessly handle executable permission issues. Gearlever can be installed directly via Flatpak:
...
* [LibrePods Official Repository](https://github.com/librepods-org/librepods)